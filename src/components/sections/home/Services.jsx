...
export default function Services() {
  return (
    <section className="py-20 bg-black px-4 max-w-7xl ">
      <h2 className="text-3xl font-bold text-start mb-4 text-white mx-8">Our Services</h2>
      <div className="w-full max-w-5xl h-[1px] bg-gray-700  mb-8 mx-8"></div>

      <div className="grid grid-cols-1 pt-5 sm:grid-cols-2 gap-0 mx-12">
