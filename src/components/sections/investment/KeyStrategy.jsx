...
const KeyStrategy = () => {
    return (
        <section className="bg-black text-white py-12 md:py-16 lg:py-20 px-4 sm:px-6 md:px-8">
            <div className="max-w-7xl mx-auto">
                {/* Heading */}
                <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-white text-start mb-4">
                ...
                <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6 md:gap-8">
                    {strategies.map((strategy) => (
                        ...
                        >
                            <Card.Title as="h4" className="text-lg sm:text-xl normal-case text-white mb-3">
                                {strategy.title}
                            </Card.Title>
