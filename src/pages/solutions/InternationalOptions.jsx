...
const InternationalOptions = () => {
  return (
    <>
      <Helmet>
        <title>International Options | Amayra Enterprises</title>
        <meta name="description" content="Explore international investment opportunities and global expansion strategies with Amayra Enterprises" />
        <meta name="keywords" content="international options, global investment, market diversification, international expansion, cross-border investment" />
      </Helmet>
